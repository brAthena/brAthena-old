...
enum {	// çFlag of the final calculation 
	BF_WEAPON	= 0x0001,
	BF_MAGIC	= 0x0002,
	BF_MISC		= 0x0004,
	BF_SHORT	= 0x0010,
...
// eAthena additions
	...
	// [brAthena]
	int server_lang, devotion_rdamage, warp_no_ress, attack_castle_monsters, gm_cant_attack, bRO_Renewal, alliance_in_woe, use_item_in_status, supports_castle_gvg, max_atk;
