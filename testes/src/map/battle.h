...
// eAthena additions
	...
	// [brAthena]
	int server_lang, devotion_rdamage, warp_no_ress, attack_castle_monsters, gm_cant_attack, bRO_Renewal, alliance_in_woe, use_item_in_status, supports_castle_gvg;
