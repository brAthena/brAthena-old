...
struct spawn_data {
	...
	unsigned int tombstone; // Sistema de T伹ulos de MvP (Tombstone) [Mark]
	struct {
...
extern char item_avail_db[32];
extern char item_noequip_db[32];
extern char item_trade_db[32];
extern char item_delay_db[32];
extern char item_buyingstore_db[32];
...
extern char elemental_db_db[32];
extern char elemental_skill_db_db[32];
