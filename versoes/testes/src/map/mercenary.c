...
int read_mercenarydb(void)
{
	...
	sv_readdb(db_path, DBPATH"mercenary_db.txt", ',', 26, 26, MAX_MERCENARY_CLASS, &read_mercenarydb_sub);
...
{
	sv_readdb(db_path, DBPATH"mercenary_skill_db.txt", ',', 3, 3, -1, &read_mercenary_skilldb_sub);
