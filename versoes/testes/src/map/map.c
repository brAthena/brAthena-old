...
char item_avail_db[32] = "item_avail";
char item_noequip_db[32] = "item_noequip";
char item_trade_db[32] = "item_trade";
char item_delay_db[32] = "item_delay";
char item_buyingstore_db[32] = "item_buyingstore";
...
/* FunÁ„o destinada a leitura dos banco de dados em formato SQL */
