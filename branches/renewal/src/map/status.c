...
void initChangeTables(void)
{
	...
	// Sic·rio - Passos de Ilus„o & Venenos.
...
int status_base_amotion_pc(struct map_session_data* sd, struct status_data* status)
{
	...
	// Ajustes vindo do bÙnus bAspd
	amotion += sd->aspd_add;
	
	// Ajustes de bÙnus vindo da habilidade PerÌcia em Esgrima
