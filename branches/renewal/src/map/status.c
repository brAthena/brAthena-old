...
void initChangeTables(void)
{
	...
	set_sc( MI_RUSH_WINDMILL            , SC_RUSHWINDMILL            , SI_RUSH_WINDMILL             , SCB_BATK );
	...
	set_sc( WM_SATURDAY_NIGHT_FEVER     , SC_SATURDAYNIGHTFEVER      , SI_SATURDAY_NIGHT_FEVER      , SCB_BATK|SCB_DEF|SCB_FLEE|SCB_SPEED|SCB_ASPD|SCB_MAXHP|SCB_REGEN );
	...
	set_sc( WM_BEYOND_OF_WARCRY         , SC_BEYONDOFWARCRY          , SI_BEYOND_OF_WARCRY          , SCB_BATK|SCB_MATK );
